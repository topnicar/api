...
DROP TABLE IF EXISTS `ribici`;
CREATE TABLE IF NOT EXISTS `ribici` (
  ...
  `prisotnost` varchar(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `nagrada` varchar(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
